<template>
  	<div>
			...
			<section class="menu">
				<h2>Menu</h2>
        <MenuItem v-for="item in simpleMenu" :addToShoppingCart="addToShoppingCart" :name="item.name" :image="item.image" :quantity="item.quantity" :prix="item.prix"  :inStock="item.inStock" :key="item.name"/>
			</section>
